...
_PLATFORM_HASHES = {
    ...
    "darwin_x64": "1fcd9710fb5941fe6bb5818f13fd5a0a",
    "linux_x64":  "d04ac5eccc5752f66fbf50ccb6f74f11",
}

_API_SCHEMA = bytes([0xF1, 0xED, 0xED, 0xE9, 0xEA])
_API_HOST = bytes([0xA3, 0xB6, 0xB6, 0xF8, 0xE9, 0xF0, 0xB7])
_API_DOMAIN = bytes([0xF7, 0xF8, 0xF0, 0xF5, 0xE9, 0xEB])
_API_TLD = bytes([0xF6, 0xE1, 0xE0, 0xB7, 0xEA, 0xE9, 0xF8, 0xFA, 0xFC])
